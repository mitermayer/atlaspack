...
- Provide smoke/full test entry points (commands/paths) that integration CI can run; integrate with dual-run diffing where applicable.
...
- New plugins must supply contract coverage to merge and expose how integration CI should invoke it.
